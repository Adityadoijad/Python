...
class Laptop(device):
    def __init__(self, company,g_ng):
        device.__init__(self,company, type="Laptop")
        self.g_ng=g_ng

    def show(self):
        device.show(self)
        print(f"Gaming or Non-Gaming : {self.g_ng}")

class processor(Laptop):
    def __init__(self, company, pname):
        Laptop.__init__(self,company, g_ng="Gaming")
        self.pname=pname

    def show(self):
        Laptop.show(self)
        print(f"Processor : {self.pname}")

a=processor("Asus","intel")
a.show() 
