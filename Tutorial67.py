...
# if not os.path.exists("Tutorial67.folder"):
#  os.mkdir("Tutorial67.folder")   


# source = 'Tutorial67.py'
# destination = 'Tutorial67.folder/Tutorial67(copy).py'

# # Copy the file
# shutil.copy(source, destination)


# source='D:\Aditya\Python'
# destination='D:\Aditya\Python\Python Tutorials\Tutorial.folder'
# #copy a folder
# shutil.copytree(source,destination)



# source = 'Tutorial67.folder/Tutorial67(copy).py'
# destination='D:\Aditya\Python\Python Tutorials\Tutorial.folder\Tutorial67(copied).py'
