...
class Animal:
    ...
    def make_sound(self):
        print(f"Animal like {self.name} which is a {self.animal} makes sounds")

class dog(Animal):
    def __init__(self, name,breed):
        Animal.__init__(self,name,animal="DOG")
        self.breed=breed
    
    def make_sound(self):
        print(f'{self.name} is a {self.animal} from {self.breed} species makes sound of "bark"')
